...
const AppSidebar: React.FC = () => {
  ...
  const { authData } = useAuth(); // ✅ ใช้ Context ที่นี่
    ...
    >
      ...
      >
        <Link to="/">
          {isExpanded || isHovered || isMobileOpen ? (
            <>
              ...
              <img
                ...
                alt="Logo"
                width={150}
                height={50}//แก้โลโก้ตรงนี้ไอ่สัส
              />
            </>
          ) : (
            <img
          ...
          {/* ✅ แสดงชื่อผู้ใช้ */}
          {authData && (
            <div className="mb-4 text-gray-700 dark:text-gray-300 text-sm font-semibold">
              Hello, {authData.commonname} ({authData.role})
            </div>
          )}
        ...
        <nav className="mb-6">
          <div className="flex flex-col gap-4">
            ...
            <div className="">
              ...
              >
                {isExpanded || isHovered || isMobileOpen ? (
                  "Power By ITS version Production"
                ) : (
                  <HorizontaLDots />
                )}
              </h2>
              {/* {renderMenuItems(othersItems, "others")แก้ด้วย8} */}
            </div>
